                ...
                : TextButton(
                    onPressed: () async {
                      ...
                      if (controller.snapshotData['password'] ==
                        ...
                        VxToast.show(context, msg: "Profil mis à jour");
                        Get.back();
                      } else if (controller
                        ...
                        VxToast.show(context, msg: "mis à jour");
                        Get.back();
                      } else {
                        VxToast.show(context, msg: "Une erreur s'est produite");
          ...
          child: Column(
            children: [
              ...
              Align(
                  ...
                  child: boldText(text: "Changez votre mot de passe")),
              10.heightBox,
              customTextField(
                label: password,
                hint: passwordHint,
